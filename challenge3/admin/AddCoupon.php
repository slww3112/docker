...
require "add_coupon_backend.php";
?>
...
<section class="contact-clean" style="background: var(--bs-gray-900);">
    <form method="post" style="background: var(--bs-gray-800);padding-bottom: 60px;max-width: 500px;margin: 0 auto">
        <h2 class="text-center" style="color: rgb(255,255,255);">Add Coupon</h2>
        <div class="form-check form-switch">
            <input class="form-check-input" type="checkbox" role="switch" id="type" name="type" />
            <label class="form-check-label" for="flexSwitchCheckDefault">Discount in € (Default is %)</label>
        </div>
            <div class="mb-3"><input class="form-control" type="number" id="value" name="value" placeholder="Value" style="background: #c6c6c6;margin-top: 20px;">
                <div class="mb-3"><input class="form-control" type="text" id="code" name="code" placeholder="Code" style="background: #c6c6c6;margin-top: 20px;"></div>
            </div>
        </div>
