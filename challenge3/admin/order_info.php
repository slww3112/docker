...
if(isset($_POST['btn_save']))
{
    ...
    mysqli_query($con,"insert into user_info2(first_name, last_name,email,password,mobile,address1,address2,item,price,quantity) values ('$first_name','$last_name','$email','$user_password','$mobile','$address1','$address2','$item','$price','$quantity')")
 ...
 <nav class="navbar navbar-light navbar-expand-md textdark text-dark">
        <div class="container-fluid"><a class="navbar-brand bg-dark" style="color: rgba(255,255,255,0.9);" href="../../index.php">Shop</a><button data-bs-toggle="collapse" class="navbar-toggler bg-dark" data-bs-target="#navcol-2" style="color: rgba(255,254,254,0.55);"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse bg-dark" id="navcol-2">
                <ul class="navbar-nav">
                    <li class="nav-item"><a class="nav-link" href="order_info.php" style="color: rgba(255,255,255,0.9);">Add User</a></li>
        ...
        <div class="card">
            ...
            <div class="card-body" style="margin-bottom: 30px">
                <form action="" method="post" name="form" enctype="multipart/form-data">
                    ...
                    <button type="submit" name="btn_save" id="btn_save" class="btn btn-primary pull-right" style="margin-top: 20px">Pay Now</button>
