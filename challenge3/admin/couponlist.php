...
if(isset($_GET['action']) && $_GET['action']!="" && $_GET['action']=='delete') {
    $product_id = $_GET['coupon_id'];


    if (isset($_GET['action']) && $_GET['action'] != "" && $_GET['action'] == 'delete') {
        $coupon_id = $_GET['coupon_id'];
        /*this is delet quer*/
        mysqli_query($con, "delete from coupon where ID = '$coupon_id'") or die("query is incorrect...");
    }
    ...
    <div class="container-fluid"><a class="navbar-brand bg-dark" style="color: rgba(255,255,255,0.9);" href="../index.php">Shop</a><button data-bs-toggle="collapse" class="navbar-toggler bg-dark" data-bs-target="#navcol-2" style="color: rgba(255,254,254,0.55);"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        <div class="collapse navbar-collapse bg-dark" id="navcol-2">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link active" style="color: rgba(255,255,255,0.9);" data-bs-target="../index.html" href="couponlist.php">Coupon List</a></li>
            </ul>
...
<div class="col-md-14" style="max-width: 1000px;margin: 0 auto">
        ...
        <div class="card-body">
            <div class="table-responsive ps">
                <table class="table tablesorter " id="page1">
                    ...
                    <tr><th>Type</th><th>Value</th><th>Code</th><th>
                            <a class=" btn btn-primary" href="AddCoupon.php">Add New</a></th></tr></thead>
                    <tbody>
                    <?php

                    $result=mysqli_query($con,"select ID, Type,coupon_value,coupon_code from coupon Limit $page1,12")or die ("query 1 incorrect.....");

                    while(list($coupon_id,$type,$value,$code)=mysqli_fetch_array($result))
                    {
                        if ($type == 0) {
                            $acttype = '%';
                        }
                        ...
                        echo "<tr><td>$acttype</td>
                        <td>$value</td>
                        <td>$code</td>
                        <td>

                         <a href='couponlist.php?coupon_id=$coupon_id&action=delete' type='button' rel='tooltip' title='' class='btn btn-danger' data-original-title='Delete Coupon'>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination">
            ...
            $paging=mysqli_query($con,"select ID, Type,coupon_value,coupon_code from coupon");
            ...
            {
                ?>
                <li class="page-item"><a class="page-link" href="couponlist.php?page=<?php echo $b;?>"><?php echo $b." ";?></a></li>
                <?php
            }
            ?>
            <li class="page-item">
